...
extern "C" DWORD64 __cdecl CreateRemoteThread64(DWORD64 hProcess, DWORD64 remote_addr, DWORD64 thread_arg)
{
    static DWORD64 nrvm = 0;
    CLIENT_ID cid = { 0 };
...
extern "C"  BOOL __cdecl CloseHandle64(DWORD64 Handle)
{
    static DWORD64 nrvm = 0;
